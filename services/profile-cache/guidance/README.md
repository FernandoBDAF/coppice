...
Profile Cache Service provides high-speed data access and caching capabilities for the profile microservices architecture. This service is responsible for improving read performance, reducing database load, and managing cache invalidation patterns.
...
- Synchronous: Direct cache operations
- Asynchronous: Cache invalidation events
...
- Use LLM for code generation
  ...
  Generate [component] for Profile Cache that:
...
- [Service Architecture](../../../docs/architecture/services/profile-cache-service.md)
...
- [API Specification](../../../docs/api/openapi/profile-cache-api.yaml)
