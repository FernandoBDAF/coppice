...
Profile Monitoring Service provides comprehensive monitoring and observability for the profile microservices architecture. This service is responsible for collecting metrics, generating alerts, visualizing system performance, and ensuring the health and reliability of all profile-related services.
...
- All profile services (for metrics collection)
...
- Use LLM for code generation
  ...
  Generate [component] for Profile Monitoring that:
...
- [Service Architecture](../../../docs/architecture/services/profile-monitoring-service.md)
...
- [API Specification](../../../docs/api/openapi/profile-monitoring-api.yaml)
